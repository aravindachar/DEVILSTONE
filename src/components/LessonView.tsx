  ...
  return (
    <div className="flex-1 flex flex-col bg-white/45 backdrop-blur-md overflow-hidden h-full">
      ...
      <div className="flex-1 overflow-y-auto p-8 md:p-12">
        <div className={`max-w-3xl mx-auto bg-white/90 shadow-xl border border-slate-200/50 rounded-3xl p-6 md:p-10 min-h-[400px] shadow-slate-100/60 transition-all duration-300 border-t-4 ${subtopic.isCompleted ? 'border-t-emerald-500' : 'border-t-slate-800'}`}>
